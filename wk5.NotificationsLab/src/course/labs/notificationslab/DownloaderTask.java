				...
				new BroadcastReceiver()
				{
					...
					public void onReceive(Context context, Intent intent)
					{
						...
						if (getResultCode() != mParentActivity.RESULT_OK)
						{
							...
							NotificationManager notifMgr = (NotificationManager) mApplicationContext.getSystemService(mApplicationContext.NOTIFICATION_SERVICE);
							notifMgr.notify(MY_NOTIFICATION_ID, notificationBuilder.build());
